...
/**
 * Class that gives recursive read-only access to settings added via
 * constructor.
 */
class ImmutableSettings extends ArrayObject implements JsonSerializable, ImmutableSettingsInterface
{
    /**
