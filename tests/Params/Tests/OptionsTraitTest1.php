...
class OptionsTraitTest extends BaseTestCase
{
    ...
    public function testTypeChangeAndAddOnDeeperLevel()
    {
        ...
        $this->assertEquals($new, $params->getOptionValues('nested.bool'));
    }
    ...
    public function testSearchOrExpression()
    {
        $params = new OptionsTraitTester();
        $params->setOptions($this->getExampleValues());
        $this->assertEquals('second level', $params->getOptionValues('nested."2nd level" || first_level'));
        $this->assertEquals('first level', $params->getOptionValues('first_level || nested."2nd level"'));
    }
    ...
    public function testDeepArrayModification()
    {
        ...
        $this->assertEquals('yes', $params->getOptionValues('nested.omg'));
    }
